...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/dokufy.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/dokufy)
...
```bash
php artisan vendor:publish --tag="dokufy-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="dokufy-views"
```

## Usage

```php
$dokufy = new CleaniqueCoders\Dokufy();
echo $dokufy->echoPhrase('Hello, CleaniqueCoders!');
```
